      ...
      <div className="container mx-auto max-w-4xl px-4 py-8 md:py-12">
        ...
        >
          ...
          <p className="mt-2 text-[11px] text-muted-foreground/80">
            YouTube uses captions when available. TikTok summarises from title +
            author only (no public transcripts).
          </p>
        </form>
        ...
        {result && (
          <article className="mt-8 space-y-6">
            ...
            <p className="text-center text-xs text-muted-foreground/60">
              Generated by gpt-4o-mini at{" "}
              {new Date(result.generatedAt).toLocaleString()}. Always
              double-check important facts against the source.
            </p>
          </article>
        )}
